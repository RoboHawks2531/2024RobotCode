    ...
    public RedAllianceTestAuto(Swerve swerve, Vision vision) {
        ...
        Trajectory speakerToTopNotTrajectory =
            TrajectoryGenerator.generateTrajectory(
                ...
                List.of( new Translation2d(14.46, 6.28) ,new Translation2d(13.66, 7.02), new Translation2d(15.15, 5.57), new Translation2d(14.66, 5.57), new Translation2d(13.66, 5.57),  new Translation2d(14.66, 5.57)),
        ...
        SwerveControllerCommand swerveControllerCommand1 =
            new SwerveControllerCommand(
                ...
                new PIDController(Constants.AutoConstants.kPXController, 2, 0.01),
                new PIDController(Constants.AutoConstants.kPYController, 2, 0.01),
                thetaController,
